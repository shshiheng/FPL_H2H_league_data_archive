...
prev=-1
buffer=0
df = pd.DataFrame(columns=['Team Name', 'Player Name','GW points' , 'Total' , 'Captain', 'Chip' , 'Bank', 'Total Team Value', 'Transfers', 'Transfer cost' , 'Points on Bench','Overall rank'])
...
outputpath='julian_standing.xlsx' 
